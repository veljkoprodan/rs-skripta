...
\titleformat{\section}[block]{\normalfont\Large\bfseries\color{black}}{\llap{\ifnum\value{section}=8\colorbox{yellow}{\makebox[1.5em][r]{\thesection}}\else\makebox[1.5em][r]{\thesection}\fi}\hspace{1em}}{0.5em}{}
...
\section{Koliko puta se poziva destruktor klase A u sledećem programu?}
    ...
    Dva puta tj. za pri deinicijalizaciji promenljivih $a$, i $b$. Promenljive $c$ i $q$ su reference 
    na objekte.
...
Klasa bi trebalo da ima samo jedan razlog da se menja. Alternativni oblici uključuju:
\begin{itemize}
  \item Jedan modul bi trebalo da ima jednu namenu.
  \item Jedan modul bi trebalo da ima samo jedan razlog za menjanje.
\end{itemize}
Ukazuje na značaj jasnog razloga za dekompoziciju, gde jedna komponenta ima jednu funkciju ili tačku promenljivosti. 

Primer primene uključuje obrazac Posetilac, gde hijerarhija klasa ima odgovornost samo za strukturu, dok se odgovornosti raspoređuju na različite posetioce.

\section{Objasniti princip otvorenosti i zatvorenosti.}
Elementi softvera bi trebalo da budu otvoreni za proširivanje i zatvoreni za menjanje. Strukturni elementi softvera bi trebalo da se mogu proširivati bez menjanja interfejsa, ali ne bi trebalo da se menjaju ako se menjaju okolnosti. 

Primer primene uključuje upotrebu hijerarhija klasa gde se otvorenost za proširivanje postiže dodavanjem novih klasa, a zatvorenost za promene očuvava stabilnim interfejsom bazne klase.

\section{Objasniti princip zamenljivosti.}
Podtipovi moraju moći da zamene bazne tipove, što predstavlja osnovu hijerarhijskog polimorfizma.

\section{Objasniti princip razdvajanja interfejsa.}
Klijenti ne bi trebalo da zavise od metoda interfejsa koje ne koriste. Osnovna ideja je da interfejsi budu zaokruženi i potpuni. To se odnosi na nepoželjne zavisnosti, sprečavajući zavisnost korisnika od nepotrebnih delova interfejsa. 

Primer narušavanja ovog principa može uključivati pisanje klasa sa širokim interfejsima, što može dovesti do nepotrebnih zavisnosti.

\section{Objasniti princip inverzne zavisnosti.}
Moduli visokog nivoa ne smeju zavisiti od modula niskog nivoa. Oba bi trebala zavisiti od apstrakcija. Ovo se postiže programiranjem prema interfejsu, a ne prema implementaciji. 

Primeri primene uključuju upotrebu polimorfizma i obrazaca kao što su sastav, posmatrač i posetilac.
...
Odgovornost za obavljanje posla dodeljuje se klasi koja ima informacije neophodne za obavljanje tog posla. 

Osnovna ideja uključuje lociranje znanja na istom mestu, enkapsulaciju znanja i smanjenje razmene informacija. 

Primeri narušavanja ovog principa mogu uključivati deljenje odgovornosti između klasa.

\section{Obasniti princip dizajna softvera Stvaralac.}
Odgovornost za pravljenje objekta klase A dodeljuje se klasi B ako važi bar jedan od uslova koji uključuju kompoziciju, referisanje ili blisku upotrebu instanci klase A. 

Osnovna ideja uključuje smanjenje broja zavisnosti i prepuštanje odgovornosti klasi koja već ima vezu sa instancama klase A.

\section{Objasniti princip dizajna softvera Visoka kohezija.}
Dodeljivati odgovornosti tako da kohezija ostane visoka.

\section{Obasniti princip dizajna softvera Niska spregnutost.}
Dodeljivati odgovornosti tako da spregnutost ostane niska

\section{Obasniti princip dizajna softvera Kontroler.}
...
\section{Obasniti princip dizajna softvera Polimorfizam.}
...
\section{Obasniti princip dizajna softvera Izmišljotina.}
...
\section{Obasniti princip dizajna softvera Indirekcija.}
...
\section{Obasniti princip dizajna softvera Izolovane promenljivosti.}
...
\section{Objasniti heurističko debagovanje.}
  ...
  \subsection{Sistem pravila Davida Agansa:}
    \begin{itemize}
    ...
    \subsubsection{Primedbe pri primeni pravila:}
      \begin{itemize}
