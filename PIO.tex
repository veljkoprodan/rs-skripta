        ...
        \item Odnosi između slučajeva upotrebe se označavaju isprekidanom
              ...
              \begin{itemize}
                \item \textit{include} - Slučaj obuhvata ceo slučaj prema kojem
                      ide strelica;
                \item \textit{extends} - Slučaj od kog ide strelica predstavlja
...
\begin{itemize}
  ...
  \item \textbf{extends:} Slučaj od kog ide strelica predstavlja moguće tj. opcionalno proširenje drugog slučaja, u vidu dodatka, ali ne i njegov obavezan deo.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Akteri:} Učesnici u slučaju upotrebe. Ako različiti subjekti imaju različite uloge, to je potrebno da se objasni.
...
\section{Koja je uloga i šta su osnovni elementi dijagrama sekvenci?}
  ...
  \begin{itemize}
    ...
    \item poruke poziva (započinju drugu liniju života)
...
\section{Šta je dekompozicija? Objasniti ulogu dekompozicije u dizajnu softvera.}
  ...
  sistema dolazi do njegove konkretne strukture. Ima sličnosti sa mehanizmom dedukcije:
...
Delovi implementacije koji čine jedan paket ne moraju da budu funkcionalno povezani, mada je to čest slučaj. Takođe, ne moraju da predstavljaju ni potpuno zaokruženu funkcionalnu celinu. Uobičajena praksa je da su elementi paketa povezani logički a ne funkcionalno.\\
...
\section{Navesti ključne principe OO dizajna.}
  \item Označavaju se skraćenicom SOLID:
  \begin{itemize}
...
\section{Objasniti princip dizajna softvera Informacioni ekspert.}
...
\section{Objasniti princip dizajna softvera Stvaralac.}
...
Spada u osnovne i najopštije principe projektovanja kao i principi Visoka kohezija i Niska spregnutost. Povezan je sa mnogim drugim principima: Indirekcija, Inverzna zavisnost, Zamenljivost itd.\\
...
\section{Šta je ad-hoc polimorfizam?}
  \begin{itemize}
...
\section{Objasniti heurističko debagovanje.}
  \begin{itemize}
    ...
    \item Predstavlja nadogradnju empirijskog metoda
